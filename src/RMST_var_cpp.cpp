...
// [[Rcpp::export]]
double RMST_var_cpp(DataFrame data, String method, double tau, double theta=1, int family=3, int n_boot=999, bool ensemble=false, NumericVector weight=NumericVector::create(), double tol=1e-6) {
