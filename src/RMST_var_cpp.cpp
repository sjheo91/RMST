...
// [[Rcpp::export]]
double RMST_var_cpp(DataFrame data, String method, double tau, double theta=1, int family=3, int n_boots=999, bool ensemble=false, NumericVector theta_vec , NumericVector weight, double tol=1e-6) {
