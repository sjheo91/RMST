...
// [[Rcpp::export]]
double RMST_var_cpp(DataFrame data, String method, double tau, double theta, int family, int n_boots, bool ensemble, NumericVector theta_vec , NumericVector weight, double tol=1e-6) {
