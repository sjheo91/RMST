...
// RMST_var_cpp
double RMST_var_cpp(DataFrame data, String method, double tau, int family, double theta, int n_boots, bool ensemble, NumericVector theta_vec, NumericVector weight, double tol);
RcppExport SEXP _RMSTdepC_RMST_var_cpp(SEXP dataSEXP, SEXP methodSEXP, SEXP tauSEXP, SEXP familySEXP, SEXP thetaSEXP, SEXP n_bootsSEXP, SEXP ensembleSEXP, SEXP theta_vecSEXP, SEXP weightSEXP, SEXP tolSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter< Rcpp::DataFrame >::type data(dataSEXP);
  ...
  rcpp_result_gen = Rcpp::wrap(RMST_var_cpp(data, method, tau, family, theta, n_boots, ensemble, theta_vec, weight, tol));
  return rcpp_result_gen;
  END_RCPP
}
